...
module TalonOne
  class ManagementApi
    ...
    # @param loyalty_program_id [Integer] Identifier of the card-based loyalty program containing the loyalty card. You can get the ID with the [List loyalty programs](https://docs.talon.one/management-api#tag/Loyalty/operation/getLoyaltyPrograms) endpoint. 
    # @param loyalty_card_id [String] Identifier of the loyalty card. You can get the identifier with the [List loyalty cards](https://docs.talon.one/management-api#tag/Loyalty-cards/operation/getLoyaltyCards) endpoint. 
    # @param update_loyalty_card [UpdateLoyaltyCard] body
    # @param [Hash] opts the optional parameters
    # @return [LoyaltyCard]
    def update_loyalty_card(loyalty_program_id, loyalty_card_id, update_loyalty_card, opts = {})
      data, _status_code, _headers = update_loyalty_card_with_http_info(loyalty_program_id, loyalty_card_id, update_loyalty_card, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(LoyaltyCard, Integer, Hash)>] LoyaltyCard data, response status code and response headers
    def update_loyalty_card_with_http_info(loyalty_program_id, loyalty_card_id, update_loyalty_card, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'update_loyalty_card' is set
      if @api_client.config.client_side_validation && update_loyalty_card.nil?
        fail ArgumentError, "Missing the required parameter 'update_loyalty_card' when calling ManagementApi.update_loyalty_card"
      end
      # resource path
      local_var_path = '/v1/loyalty_programs/{loyaltyProgramId}/cards/{loyaltyCardId}'.sub('{' + 'loyaltyProgramId' + '}', CGI.escape(loyalty_program_id.to_s)).sub('{' + 'loyaltyCardId' + '}', CGI.escape(loyalty_card_id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(update_loyalty_card)
