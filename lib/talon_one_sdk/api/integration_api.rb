...
module TalonOne
  class IntegrationApi
    ...
    # @param activate_loyalty_points [ActivateLoyaltyPoints] body
    ...
    # @param integration_id [String] The integration ID of the customer profile. You can get the &#x60;integrationId&#x60; of a profile using: - A customer session integration ID with the [Update customer session](https://docs.talon.one/integration-api#tag/Customer-sessions/operation/updateCustomerSessionV2) endpoint. - The Management API with the [List application&#39;s customers](https://docs.talon.one/management-api#tag/Customer-data/operation/getApplicationCustomers) endpoint. 
    # @param delete_loyalty_transactions_request [DeleteLoyaltyTransactionsRequest] 
    # @param [Hash] opts the optional parameters
    # @return [nil]
    ...
    def get_event_v3_with_http_info(integration_id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'EventV3'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['api_key_v1']

      new_options = opts.merge(
        :operation => :"IntegrationApi.get_event_v3",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @option opts [Integer] :store_id Filter results to campaigns linked to the specified store ID.
    # @option opts [Integer] :audience_id Filter results to campaigns linked to the specified audience ID.
    # @return [Array<(IntegrationGetAllCampaigns200Response, Integer, Hash)>] IntegrationGetAllCampaigns200Response data, response status code and response headers
    ...
    def integration_rewards_catalog_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'points_from'].nil? && opts[:'points_from'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"points_from"]" when calling IntegrationApi.integration_rewards_catalog, must be greater than 0.'
      end

      if @api_client.config.client_side_validation && !opts[:'points_to'].nil? && opts[:'points_to'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"points_to"]" when calling IntegrationApi.integration_rewards_catalog, must be greater than 0.'
      end
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'IntegrationRewardsCatalog200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['api_key_v1']

      new_options = opts.merge(
        :operation => :"IntegrationApi.integration_rewards_catalog",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def join_loyalty_program_with_http_info(loyalty_program_id, integration_id, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"IntegrationApi.join_loyalty_program",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :idempotency_key A unique identifier that enables idempotent processing. Include it to ensure that the request is processed only once, even if you send it several times.
    ...
    # @param integration_event_v3_request [IntegrationEventV3Request] body
    # @param [Hash] opts the optional parameters
    # @option opts [String] :silent Possible values: &#x60;yes&#x60; or &#x60;no&#x60;. - &#x60;yes&#x60;: Increases the performance of the API call by returning a 204 response. - &#x60;no&#x60;: Returns a 200 response that contains the updated customer profiles.  (default to 'yes')
    # @option opts [Boolean] :dry Indicates whether to persist the changes. Changes are ignored when &#x60;dry&#x3D;true&#x60;. 
    # @option opts [Boolean] :force_complete_evaluation Forces evaluation for all matching campaigns regardless of the [campaign evaluation mode](https://docs.talon.one/docs/product/applications/managing-campaign-evaluation#setting-campaign-evaluation-mode). Requires &#x60;dry&#x3D;true&#x60;.  (default to false)
    # @return [IntegrationEventV3Response]
    def track_event_v3(integration_event_v3_request, opts = {})
      data, _status_code, _headers = track_event_v3_with_http_info(integration_event_v3_request, opts)
      data
    end
    ...
    def track_event_v3_with_http_info(integration_event_v3_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: IntegrationApi.track_event_v3 ...'
      end
      # verify the required parameter 'integration_event_v3_request' is set
      if @api_client.config.client_side_validation && integration_event_v3_request.nil?
        fail ArgumentError, "Missing the required parameter 'integration_event_v3_request' when calling IntegrationApi.track_event_v3"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(integration_event_v3_request)

      # return_type
      return_type = opts[:debug_return_type] || 'IntegrationEventV3Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['api_key_v1']

      new_options = opts.merge(
        :operation => :"IntegrationApi.track_event_v3",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def unlock_reward_with_http_info(reward_id, integration_unlock_reward_request, opts = {})
      ...
      # verify the required parameter 'integration_unlock_reward_request' is set
      if @api_client.config.client_side_validation && integration_unlock_reward_request.nil?
        fail ArgumentError, "Missing the required parameter 'integration_unlock_reward_request' when calling IntegrationApi.unlock_reward"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"IntegrationApi.unlock_reward",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
