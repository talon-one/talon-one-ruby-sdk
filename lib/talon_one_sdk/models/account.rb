...
module TalonOne
  class Account < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TalonOne::Account`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] application_count Value to be assigned
    def application_count=(application_count)
      if application_count.nil?
        fail ArgumentError, 'application_count cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] user_count Value to be assigned
    def user_count=(user_count)
      if user_count.nil?
        fail ArgumentError, 'user_count cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] campaigns_active_count Value to be assigned
    def campaigns_active_count=(campaigns_active_count)
      if campaigns_active_count.nil?
        fail ArgumentError, 'campaigns_active_count cannot be nil'
      end

      @campaigns_active_count = campaigns_active_count
    end

    # Custom attribute writer method with validation
    # @param [Object] campaigns_inactive_count Value to be assigned
    def campaigns_inactive_count=(campaigns_inactive_count)
      if campaigns_inactive_count.nil?
        fail ArgumentError, 'campaigns_inactive_count cannot be nil'
      end

      @campaigns_inactive_count = campaigns_inactive_count
    end
