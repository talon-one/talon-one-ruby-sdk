...
module TalonOne
  class GenerateRuleTitleRule < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TalonOne::GenerateRuleTitleRule`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@condition.nil? && @condition.length < 1
    ...
    def valid?
      ...
      return false if !@condition.nil? && @condition.length < 1
      true
    end
    ...
    def condition=(condition)
      ...
      if condition.length < 1
        fail ArgumentError, 'invalid value for "condition", number of items must be greater than or equal to 1.'
      end
