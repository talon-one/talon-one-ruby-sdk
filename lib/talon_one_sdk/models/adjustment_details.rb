...
module TalonOne
  ...
  class AdjustmentDetails < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TalonOne::AdjustmentDetails`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] selected_price_type Value to be assigned
    def selected_price_type=(selected_price_type)
      if selected_price_type.nil?
        fail ArgumentError, 'selected_price_type cannot be nil'
      end
