...
module TalonOne
  class CatalogSyncRequest < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TalonOne::CatalogSyncRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @actions.length > 1000
        invalid_properties.push('invalid value for "actions", number of items must be less than or equal to 1000.')
      end
    ...
    def valid?
      ...
      return false if @actions.length > 1000
    ...
    def actions=(actions)
      ...
      if actions.length > 1000
        fail ArgumentError, 'invalid value for "actions", number of items must be less than or equal to 1000.'
      end
