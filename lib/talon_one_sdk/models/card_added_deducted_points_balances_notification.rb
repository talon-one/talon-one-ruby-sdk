...
module TalonOne
  class CardAddedDeductedPointsBalancesNotification < ApiModelBase
    ...
    attr_accessor :profile_integration_ids
    ...
    def self.attribute_map
      {
        ...
        :'profile_integration_ids' => :'ProfileIntegrationIDs',
    ...
    def self.openapi_types
      {
        ...
        :'profile_integration_ids' => :'Array<String>',
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TalonOne::CardAddedDeductedPointsBalancesNotification`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'profile_integration_ids')
        if (value = attributes[:'profile_integration_ids']).is_a?(Array)
          self.profile_integration_ids = value
        end
      else
        self.profile_integration_ids = nil
      end
    ...
    def list_invalid_properties
      ...
      if @profile_integration_ids.nil?
        invalid_properties.push('invalid value for "profile_integration_ids", profile_integration_ids cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @profile_integration_ids.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Object] profile_integration_ids Value to be assigned
    def profile_integration_ids=(profile_integration_ids)
      if profile_integration_ids.nil?
        fail ArgumentError, 'profile_integration_ids cannot be nil'
      end

      @profile_integration_ids = profile_integration_ids
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          profile_integration_ids == o.profile_integration_ids &&
    ...
    def hash
      [card_identifier, employee_name, loyalty_program_id, notification_type, profile_integration_ids, session_integration_id, subledger_id, type_of_change, user_id, users_per_card_limit, actions, current_points].hash
    end
