...
module TalonOne
  ...
  class RiskDetail < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TalonOne::RiskDetail`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] affected_entities Value to be assigned
    def affected_entities=(affected_entities)
      if affected_entities.nil?
        fail ArgumentError, 'affected_entities cannot be nil'
      end
