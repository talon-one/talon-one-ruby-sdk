...
module TalonOne
  ...
  class ReferralRejectionReason < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TalonOne::ReferralRejectionReason`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] referral_id Value to be assigned
    def referral_id=(referral_id)
      if referral_id.nil?
        fail ArgumentError, 'referral_id cannot be nil'
      end
