...
module TalonOne
  class NewCouponsForMultipleRecipients < ApiModelBase
    ...
    # Custom attribute writer method with validation
    # @param [Object] recipients_integration_ids Value to be assigned
    def recipients_integration_ids=(recipients_integration_ids)
      if recipients_integration_ids.nil?
        fail ArgumentError, 'recipients_integration_ids cannot be nil'
      end

      if recipients_integration_ids.length > 1000
        fail ArgumentError, 'invalid value for "recipients_integration_ids", number of items must be less than or equal to 1000.'
      end

      if recipients_integration_ids.length < 1
        fail ArgumentError, 'invalid value for "recipients_integration_ids", number of items must be greater than or equal to 1.'
      end

      @recipients_integration_ids = recipients_integration_ids
    end
    ...
    def coupon_pattern=(coupon_pattern)
      ...
      if coupon_pattern.to_s.length < 3
        fail ArgumentError, 'invalid value for "coupon_pattern", the character length must be greater than or equal to 3.'
      end
