...
module TalonOne
  class AnalyticsDataPointWithTrendAndInfluencedRate < ApiModelBase
    attr_accessor :value
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TalonOne::AnalyticsDataPointWithTrendAndInfluencedRate`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] influenced_rate Value to be assigned
    def influenced_rate=(influenced_rate)
      if influenced_rate.nil?
        fail ArgumentError, 'influenced_rate cannot be nil'
      end

      @influenced_rate = influenced_rate
    end
