...
module TalonOne
  class CodeGeneratorSettings < ApiModelBase
    ...
    # @param [Object] valid_characters Value to be assigned
    def valid_characters=(valid_characters)
      if valid_characters.nil?
        fail ArgumentError, 'valid_characters cannot be nil'
      end
