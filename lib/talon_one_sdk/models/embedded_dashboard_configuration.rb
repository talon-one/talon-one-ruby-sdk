...
module TalonOne
  class EmbeddedDashboardConfiguration < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TalonOne::EmbeddedDashboardConfiguration`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] dashboard_id Value to be assigned
    def dashboard_id=(dashboard_id)
      if dashboard_id.nil?
        fail ArgumentError, 'dashboard_id cannot be nil'
      end
