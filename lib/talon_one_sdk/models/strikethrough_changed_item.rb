...
module TalonOne
  ...
  class StrikethroughChangedItem < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TalonOne::StrikethroughChangedItem`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] evaluated_at Value to be assigned
    def evaluated_at=(evaluated_at)
      if evaluated_at.nil?
        fail ArgumentError, 'evaluated_at cannot be nil'
      end
