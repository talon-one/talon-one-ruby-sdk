...
module TalonOne
  class NewReferralsForMultipleAdvocates < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TalonOne::NewReferralsForMultipleAdvocates`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'advocate_profile_integration_ids')
        ...
        self.advocate_profile_integration_ids = nil
      end
    ...
    def list_invalid_properties
      ...
      if @advocate_profile_integration_ids.length > 1000
        invalid_properties.push('invalid value for "advocate_profile_integration_ids", number of items must be less than or equal to 1000.')
      end

      if @advocate_profile_integration_ids.length < 1
        invalid_properties.push('invalid value for "advocate_profile_integration_ids", number of items must be greater than or equal to 1.')
      end
      ...
      if !@referral_pattern.nil? && @referral_pattern.to_s.length < 3
        invalid_properties.push('invalid value for "referral_pattern", the character length must be greater than or equal to 3.')
      end
    ...
    def valid?
      ...
      return false if @advocate_profile_integration_ids.length > 1000
      return false if @advocate_profile_integration_ids.length < 1
    ...
    # Custom attribute writer method with validation
    # @param [Object] advocate_profile_integration_ids Value to be assigned
    def advocate_profile_integration_ids=(advocate_profile_integration_ids)
      if advocate_profile_integration_ids.nil?
        fail ArgumentError, 'advocate_profile_integration_ids cannot be nil'
      end

      if advocate_profile_integration_ids.length > 1000
        fail ArgumentError, 'invalid value for "advocate_profile_integration_ids", number of items must be less than or equal to 1000.'
      end

      if advocate_profile_integration_ids.length < 1
        fail ArgumentError, 'invalid value for "advocate_profile_integration_ids", number of items must be greater than or equal to 1.'
      end

      @advocate_profile_integration_ids = advocate_profile_integration_ids
    end

    # Custom attribute writer method with validation
    # @param [Object] referral_pattern Value to be assigned
    def referral_pattern=(referral_pattern)
      if referral_pattern.nil?
        fail ArgumentError, 'referral_pattern cannot be nil'
      end

      if referral_pattern.to_s.length > 100
        fail ArgumentError, 'invalid value for "referral_pattern", the character length must be smaller than or equal to 100.'
      end

      if referral_pattern.to_s.length < 3
        fail ArgumentError, 'invalid value for "referral_pattern", the character length must be greater than or equal to 3.'
      end
