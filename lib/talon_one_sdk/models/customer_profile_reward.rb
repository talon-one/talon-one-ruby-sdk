  ...
  class CustomerProfileReward < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'reward_integration_id')
        ...
        self.reward_integration_id = nil
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] reward_integration_id Value to be assigned
    def reward_integration_id=(reward_integration_id)
      if reward_integration_id.nil?
        fail ArgumentError, 'reward_integration_id cannot be nil'
      end

      @reward_integration_id = reward_integration_id
    end
