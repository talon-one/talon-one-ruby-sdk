...
module TalonOne
  class NewMultipleAudiencesItem < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TalonOne::NewMultipleAudiencesItem`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] subscribed_applications_ids Value to be assigned
    def subscribed_applications_ids=(subscribed_applications_ids)
      if subscribed_applications_ids.nil?
        fail ArgumentError, 'subscribed_applications_ids cannot be nil'
      end

      @subscribed_applications_ids = subscribed_applications_ids
    end
