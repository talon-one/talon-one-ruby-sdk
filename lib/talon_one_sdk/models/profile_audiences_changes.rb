...
module TalonOne
  class ProfileAudiencesChanges < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TalonOne::ProfileAudiencesChanges`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # @param [Object] adds Value to be assigned
    def adds=(adds)
      if adds.nil?
        fail ArgumentError, 'adds cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] deletes Value to be assigned
    def deletes=(deletes)
      if deletes.nil?
        fail ArgumentError, 'deletes cannot be nil'
      end
