...
module TalonOne
  class MessageTest < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TalonOne::MessageTest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # @param [Object] http_response Value to be assigned
    def http_response=(http_response)
      if http_response.nil?
        fail ArgumentError, 'http_response cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] http_status Value to be assigned
    def http_status=(http_status)
      if http_status.nil?
        fail ArgumentError, 'http_status cannot be nil'
      end
