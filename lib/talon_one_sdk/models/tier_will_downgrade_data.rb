...
module TalonOne
  class TierWillDowngradeData < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TalonOne::TierWillDowngradeData`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'points_required_to_remain')
        ...
        self.points_required_to_remain = nil
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] points_required_to_remain Value to be assigned
    def points_required_to_remain=(points_required_to_remain)
      if points_required_to_remain.nil?
        fail ArgumentError, 'points_required_to_remain cannot be nil'
      end
