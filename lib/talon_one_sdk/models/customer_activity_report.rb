...
module TalonOne
  ...
  class CustomerActivityReport < ApiModelBase
    ...
    # Custom attribute writer method with validation
    # @param [Object] coupon_use_attempts Value to be assigned
    def coupon_use_attempts=(coupon_use_attempts)
      if coupon_use_attempts.nil?
        fail ArgumentError, 'coupon_use_attempts cannot be nil'
      end

      @coupon_use_attempts = coupon_use_attempts
    end

    # Custom attribute writer method with validation
    # @param [Object] coupon_failed_attempts Value to be assigned
    def coupon_failed_attempts=(coupon_failed_attempts)
      if coupon_failed_attempts.nil?
        fail ArgumentError, 'coupon_failed_attempts cannot be nil'
      end

      @coupon_failed_attempts = coupon_failed_attempts
    end

    # Custom attribute writer method with validation
    # @param [Object] accrued_discounts Value to be assigned
    def accrued_discounts=(accrued_discounts)
      if accrued_discounts.nil?
        fail ArgumentError, 'accrued_discounts cannot be nil'
      end

      @accrued_discounts = accrued_discounts
    end

    # Custom attribute writer method with validation
    # @param [Object] accrued_revenue Value to be assigned
    def accrued_revenue=(accrued_revenue)
      if accrued_revenue.nil?
        fail ArgumentError, 'accrued_revenue cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] total_orders Value to be assigned
    def total_orders=(total_orders)
      if total_orders.nil?
        fail ArgumentError, 'total_orders cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] total_orders_no_coupon Value to be assigned
    def total_orders_no_coupon=(total_orders_no_coupon)
      if total_orders_no_coupon.nil?
        fail ArgumentError, 'total_orders_no_coupon cannot be nil'
      end

      @total_orders_no_coupon = total_orders_no_coupon
    end
