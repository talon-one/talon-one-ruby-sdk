...
module TalonOne
  ...
  class AccessLogEntry < ApiModelBase
    ...
    # Custom attribute writer method with validation
    # @param [Object] request_uri Value to be assigned
    def request_uri=(request_uri)
      if request_uri.nil?
        fail ArgumentError, 'request_uri cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] request_payload Value to be assigned
    def request_payload=(request_payload)
      if request_payload.nil?
        fail ArgumentError, 'request_payload cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] response_payload Value to be assigned
    def response_payload=(response_payload)
      if response_payload.nil?
        fail ArgumentError, 'response_payload cannot be nil'
      end
