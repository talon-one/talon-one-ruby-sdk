...
module TalonOne
  ...
  class CustomerAnalytics < ApiModelBase
    ...
    # @param [Object] accepted_coupons Value to be assigned
    def accepted_coupons=(accepted_coupons)
      if accepted_coupons.nil?
        fail ArgumentError, 'accepted_coupons cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] free_items Value to be assigned
    def free_items=(free_items)
      if free_items.nil?
        fail ArgumentError, 'free_items cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] total_discounted_orders Value to be assigned
    def total_discounted_orders=(total_discounted_orders)
      if total_discounted_orders.nil?
        fail ArgumentError, 'total_discounted_orders cannot be nil'
      end

      @total_discounted_orders = total_discounted_orders
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] total_discounts Value to be assigned
    def total_discounts=(total_discounts)
      if total_discounts.nil?
        fail ArgumentError, 'total_discounts cannot be nil'
      end
