...
module TalonOne
  class RevisionVersion < ApiModelBase
    ...
    def hash
      [id, name, start_time, end_time, attributes, description, active_ruleset_id, tags, coupon_settings, referral_settings, limits, reevaluate_on_return, features, coupon_attributes, account_id, application_id, campaign_id, created, created_by, revision_id, version].hash
    end
