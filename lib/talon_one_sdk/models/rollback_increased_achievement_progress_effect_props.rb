...
module TalonOne
  ...
  class RollbackIncreasedAchievementProgressEffectProps < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TalonOne::RollbackIncreasedAchievementProgressEffectProps`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] decrease_progress_by Value to be assigned
    def decrease_progress_by=(decrease_progress_by)
      if decrease_progress_by.nil?
        fail ArgumentError, 'decrease_progress_by cannot be nil'
      end

      @decrease_progress_by = decrease_progress_by
    end

    # Custom attribute writer method with validation
    # @param [Object] current_progress Value to be assigned
    def current_progress=(current_progress)
      if current_progress.nil?
        fail ArgumentError, 'current_progress cannot be nil'
      end
