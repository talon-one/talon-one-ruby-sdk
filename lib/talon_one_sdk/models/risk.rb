...
module TalonOne
  ...
  class Risk < ApiModelBase
    ...
    def hash
      [id, created, notification_id, feature_date, group_key, application_id, status, criticality, entity, activity, time_frame, reported_date, affected_entity_count, description, modified].hash
    end
