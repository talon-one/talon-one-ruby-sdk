...
module TalonOne
  class PrismaticEventPayloadCouponBasedNotifications < ApiModelBase
    ...
    def hash
      [id, created, campaign_id, value, usage_limit, discount_limit, reservation_limit, start_date, expiry_date, usage_counter, discount_counter, discount_remainder, referral_id, recipient_integration_id, import_id, batch_id, attributes, limits, source_of_event, employee_name].hash
    end
