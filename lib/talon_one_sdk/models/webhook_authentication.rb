...
module TalonOne
  class WebhookAuthentication < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TalonOne::WebhookAuthentication`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] modified_by Value to be assigned
    def modified_by=(modified_by)
      if modified_by.nil?
        fail ArgumentError, 'modified_by cannot be nil'
      end
    ...
    def hash
      [name, type, data, id, created, modified, created_by, modified_by, webhooks].hash
    end
