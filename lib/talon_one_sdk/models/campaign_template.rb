...
module TalonOne
  class CampaignTemplate < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TalonOne::CampaignTemplate`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'valid_application_ids')
        ...
        self.valid_application_ids = nil
      end
    ...
    def applications_ids=(applications_ids)
      if applications_ids.nil?
        fail ArgumentError, 'applications_ids cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] valid_application_ids Value to be assigned
    def valid_application_ids=(valid_application_ids)
      if valid_application_ids.nil?
        fail ArgumentError, 'valid_application_ids cannot be nil'
      end

      @valid_application_ids = valid_application_ids
    end
