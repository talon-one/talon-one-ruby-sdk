...
module TalonOne
  class IntegrationCoupon < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TalonOne::IntegrationCoupon`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'profile_redemption_count')
        ...
        self.profile_redemption_count = nil
      end
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] profile_redemption_count Value to be assigned
    def profile_redemption_count=(profile_redemption_count)
      if profile_redemption_count.nil?
        fail ArgumentError, 'profile_redemption_count cannot be nil'
      end

      @profile_redemption_count = profile_redemption_count
    end
