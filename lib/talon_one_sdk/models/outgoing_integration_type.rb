...
module TalonOne
  class OutgoingIntegrationType < ApiModelBase
    ...
    def documentation_link=(documentation_link)
      if documentation_link.nil?
        fail ArgumentError, 'documentation_link cannot be nil'
      end

      if documentation_link.to_s.length > 255
        fail ArgumentError, 'invalid value for "documentation_link", the character length must be smaller than or equal to 255.'
      end

      if documentation_link.to_s.length < 1
        fail ArgumentError, 'invalid value for "documentation_link", the character length must be greater than or equal to 1.'
      end
