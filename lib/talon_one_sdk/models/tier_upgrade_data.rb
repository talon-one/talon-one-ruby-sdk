...
module TalonOne
  class TierUpgradeData < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TalonOne::TierUpgradeData`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] tier_expiration_date Value to be assigned
    def tier_expiration_date=(tier_expiration_date)
      if tier_expiration_date.nil?
        fail ArgumentError, 'tier_expiration_date cannot be nil'
      end

      @tier_expiration_date = tier_expiration_date
    end
