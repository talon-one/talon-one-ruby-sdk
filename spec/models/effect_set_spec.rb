...
# Unit tests for TalonOne::EffectSet
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TalonOne::EffectSet do
  #let(:instance) { TalonOne::EffectSet.new }

  describe 'test an instance of EffectSet' do
    it 'should create an instance of EffectSet' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TalonOne::EffectSet)
    end
  end
