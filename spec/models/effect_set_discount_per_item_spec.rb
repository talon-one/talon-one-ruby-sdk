...
# Unit tests for TalonOne::EffectSetDiscountPerItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TalonOne::EffectSetDiscountPerItem do
  #let(:instance) { TalonOne::EffectSetDiscountPerItem.new }

  describe 'test an instance of EffectSetDiscountPerItem' do
    it 'should create an instance of EffectSetDiscountPerItem' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TalonOne::EffectSetDiscountPerItem)
    end
  end
