...
# Unit tests for TalonOne::EffectSetDiscount
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TalonOne::EffectSetDiscount do
  #let(:instance) { TalonOne::EffectSetDiscount.new }

  describe 'test an instance of EffectSetDiscount' do
    it 'should create an instance of EffectSetDiscount' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TalonOne::EffectSetDiscount)
    end
  end
