...
# Unit tests for TalonOne::EffectCouponCreated
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TalonOne::EffectCouponCreated do
  #let(:instance) { TalonOne::EffectCouponCreated.new }

  describe 'test an instance of EffectCouponCreated' do
    it 'should create an instance of EffectCouponCreated' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TalonOne::EffectCouponCreated)
    end
  end
