...
# Unit tests for TalonOne::StrikethroughCheckAttributeBlock
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TalonOne::StrikethroughCheckAttributeBlock do
  #let(:instance) { TalonOne::StrikethroughCheckAttributeBlock.new }

  describe 'test an instance of StrikethroughCheckAttributeBlock' do
    it 'should create an instance of StrikethroughCheckAttributeBlock' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TalonOne::StrikethroughCheckAttributeBlock)
    end
  end
