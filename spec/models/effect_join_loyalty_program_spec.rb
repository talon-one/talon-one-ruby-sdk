...
# Unit tests for TalonOne::EffectJoinLoyaltyProgram
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TalonOne::EffectJoinLoyaltyProgram do
  #let(:instance) { TalonOne::EffectJoinLoyaltyProgram.new }

  describe 'test an instance of EffectJoinLoyaltyProgram' do
    it 'should create an instance of EffectJoinLoyaltyProgram' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TalonOne::EffectJoinLoyaltyProgram)
    end
  end
  ...
  describe 'test attribute "effect_type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["joinLoyaltyProgram"])
