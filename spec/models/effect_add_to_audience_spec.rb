...
# Unit tests for TalonOne::EffectAddToAudience
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TalonOne::EffectAddToAudience do
  #let(:instance) { TalonOne::EffectAddToAudience.new }

  describe 'test an instance of EffectAddToAudience' do
    it 'should create an instance of EffectAddToAudience' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TalonOne::EffectAddToAudience)
    end
  end
  ...
  describe 'test attribute "effect_type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["addToAudience"])
