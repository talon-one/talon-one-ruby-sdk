...
# Unit tests for TalonOne::EffectRejectCoupon
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TalonOne::EffectRejectCoupon do
  #let(:instance) { TalonOne::EffectRejectCoupon.new }

  describe 'test an instance of EffectRejectCoupon' do
    it 'should create an instance of EffectRejectCoupon' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TalonOne::EffectRejectCoupon)
    end
  end
  ...
  describe 'test attribute "effect_type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["rejectCoupon"])
