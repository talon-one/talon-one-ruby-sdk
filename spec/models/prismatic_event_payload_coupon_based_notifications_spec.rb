...
# Unit tests for TalonOne::PrismaticEventPayloadCouponBasedNotifications
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TalonOne::PrismaticEventPayloadCouponBasedNotifications do
  #let(:instance) { TalonOne::PrismaticEventPayloadCouponBasedNotifications.new }

  describe 'test an instance of PrismaticEventPayloadCouponBasedNotifications' do
    it 'should create an instance of PrismaticEventPayloadCouponBasedNotifications' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TalonOne::PrismaticEventPayloadCouponBasedNotifications)
    end
  end
