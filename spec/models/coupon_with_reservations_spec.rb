...
# Unit tests for TalonOne::CouponWithReservations
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TalonOne::CouponWithReservations do
  #let(:instance) { TalonOne::CouponWithReservations.new }

  describe 'test an instance of CouponWithReservations' do
    it 'should create an instance of CouponWithReservations' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TalonOne::CouponWithReservations)
    end
  end
