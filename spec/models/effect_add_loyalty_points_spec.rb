...
# Unit tests for TalonOne::EffectAddLoyaltyPoints
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TalonOne::EffectAddLoyaltyPoints do
  #let(:instance) { TalonOne::EffectAddLoyaltyPoints.new }

  describe 'test an instance of EffectAddLoyaltyPoints' do
    it 'should create an instance of EffectAddLoyaltyPoints' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TalonOne::EffectAddLoyaltyPoints)
    end
  end
  ...
  describe 'test attribute "effect_type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["addLoyaltyPoints"])
