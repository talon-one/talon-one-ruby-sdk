...
# Unit tests for TalonOne::EffectError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TalonOne::EffectError do
  #let(:instance) { TalonOne::EffectError.new }

  describe 'test an instance of EffectError' do
    it 'should create an instance of EffectError' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TalonOne::EffectError)
    end
  end
