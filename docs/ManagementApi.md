...
begin
  # Create coupons asynchronously
  result = api_instance.create_coupons_asynchronously(application_id, campaign_id, new_coupon_creation_job)
  p result
rescue TalonOne::ApiError => e
  puts "Error when calling ManagementApi->create_coupons_asynchronously: #{e}"
end
```

#### Using the create_coupons_asynchronously_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<AsyncCouponCreationResponse>, Integer, Hash)> create_coupons_asynchronously_with_http_info(application_id, campaign_id, new_coupon_creation_job)

```ruby
begin
  # Create coupons asynchronously
  data, status_code, headers = api_instance.create_coupons_asynchronously_with_http_info(application_id, campaign_id, new_coupon_creation_job)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <AsyncCouponCreationResponse>
rescue TalonOne::ApiError => e
  puts "Error when calling ManagementApi->create_coupons_asynchronously_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ManagementApi->export_application_campaign_analytics: #{e}"
end
```

#### Using the export_application_campaign_analytics_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(String, Integer, Hash)> export_application_campaign_analytics_with_http_info(application_id, range_start, range_end, opts)

```ruby
begin
  # Export Application analytics aggregated by campaign
  data, status_code, headers = api_instance.export_application_campaign_analytics_with_http_info(application_id, range_start, range_end, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => String
rescue TalonOne::ApiError => e
  puts "Error when calling ManagementApi->export_application_campaign_analytics_with_http_info: #{e}"
end
```
...
application_id = 789 # Integer | The ID of the Application. It is displayed in your Talon.One deployment URL.
campaign_id = 789 # Integer | The ID of the campaign. It is displayed in your Talon.One deployment URL.
value_map_id = 789 # Integer | The ID of the value map. 
...
begin
  ...
  puts "Error when calling ManagementApi->export_campaign_value_map: #{e}"
end
```

#### Using the export_campaign_value_map_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(String, Integer, Hash)> export_campaign_value_map_with_http_info(application_id, campaign_id, value_map_id)

```ruby
begin
  # Export campaign value map
  data, status_code, headers = api_instance.export_campaign_value_map_with_http_info(application_id, campaign_id, value_map_id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => String
rescue TalonOne::ApiError => e
  puts "Error when calling ManagementApi->export_campaign_value_map_with_http_info: #{e}"
end
```
...
opts = {
  ...
  updated_before: Time.parse('2013-10-20T19:20:30+01:00'), # Time | Filter results comparing the parameter value, expected to be an RFC3339 timestamp string.
  updated_after: Time.parse('2013-10-20T19:20:30+01:00'), # Time | Filter results comparing the parameter value, expected to be an RFC3339 timestamp string.
...
| **updated_before** | **Time** | Filter results comparing the parameter value, expected to be an RFC3339 timestamp string. | [optional] |
| **updated_after** | **Time** | Filter results comparing the parameter value, expected to be an RFC3339 timestamp string. | [optional] |
...
begin
  ...
  puts "Error when calling ManagementApi->export_loyalty_join_dates: #{e}"
end
```

#### Using the export_loyalty_join_dates_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(String, Integer, Hash)> export_loyalty_join_dates_with_http_info(loyalty_program_id)

```ruby
begin
  # Export customers' loyalty program join dates
  data, status_code, headers = api_instance.export_loyalty_join_dates_with_http_info(loyalty_program_id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => String
rescue TalonOne::ApiError => e
  puts "Error when calling ManagementApi->export_loyalty_join_dates_with_http_info: #{e}"
end
```
...
api_instance = TalonOne::ManagementApi.new
account_id = 789 # Integer | The identifier of the account. Retrieve it via the [List users in account](https://docs.talon.one/management-api#tag/Accounts-and-users/operation/getUsers) endpoint in the `accountId` property. 
...
api_instance = TalonOne::ManagementApi.new
application_id = 789 # Integer | The ID of the Application. It is displayed in your Talon.One deployment URL.
cart_item_filter_id = 789 # Integer | The ID of the Application cart item filter. You can get this ID with the [List Application cart item filters](https://docs.talon.one/management-api#tag/Applications/operation/listApplicationCartItemFilters) endpoint.
expression_id = 789 # Integer | The ID of the Application cart item filter expression.
...
begin
  ...
  puts "Error when calling ManagementApi->get_application_cart_item_filter_expression: #{e}"
end
```

#### Using the get_application_cart_item_filter_expression_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<ApplicationCIFExpression>, Integer, Hash)> get_application_cart_item_filter_expression_with_http_info(application_id, cart_item_filter_id, expression_id)

```ruby
begin
  # Get Application cart item filter expression
  data, status_code, headers = api_instance.get_application_cart_item_filter_expression_with_http_info(application_id, cart_item_filter_id, expression_id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <ApplicationCIFExpression>
rescue TalonOne::ApiError => e
  puts "Error when calling ManagementApi->get_application_cart_item_filter_expression_with_http_info: #{e}"
end
```
...
api_instance = TalonOne::ManagementApi.new
application_id = 789 # Integer | The ID of the Application. It is displayed in your Talon.One deployment URL.
customer_id = 789 # Integer | The value of the `id` property of a customer profile. Get it with the [List Application's customers](https://docs.talon.one/management-api#tag/Customer-data/operation/getApplicationCustomers) endpoint. 
...
opts = {
  ...
  skip: 789, # Integer | The number of items to skip when paging through large result sets.
  sort: 'sort_example', # String | The field by which results should be sorted. By default, results are sorted in ascending order. To sort them in descending order, prefix the field name with `-`.  **Note:** You may not be able to use all fields for sorting. This is due to performance limitations. 
  partial_match: true, # Boolean | Enables partial matching for a single text search field. When enabled, the search term matches anywhere within the field value (case-insensitive). Minimum 3 characters required for partial matches; shorter inputs automatically fall back to exact match.  **Note:** Use with one of: `integrationId`, `profile`, `coupon`, `referral`, or `storeIntegrationId`.
...
api_instance = TalonOne::ManagementApi.new
application_id = 789 # Integer | The ID of the Application. It is displayed in your Talon.One deployment URL.
experiment_id = 789 # Integer | The ID of the experiment.
...
begin
  ...
  puts "Error when calling ManagementApi->get_experiment: #{e}"
end
```
...
> <Array(<Experiment>, Integer, Hash)> get_experiment_with_http_info(application_id, experiment_id)

```ruby
begin
  # Get experiment in Application
  data, status_code, headers = api_instance.get_experiment_with_http_info(application_id, experiment_id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <Experiment>
rescue TalonOne::ApiError => e
  puts "Error when calling ManagementApi->get_experiment_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ManagementApi->import_loyalty_join_dates: #{e}"
end
```

#### Using the import_loyalty_join_dates_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<Import>, Integer, Hash)> import_loyalty_join_dates_with_http_info(loyalty_program_id, opts)

```ruby
begin
  # Import join dates for a loyalty program
  data, status_code, headers = api_instance.import_loyalty_join_dates_with_http_info(loyalty_program_id, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <Import>
rescue TalonOne::ApiError => e
  puts "Error when calling ManagementApi->import_loyalty_join_dates_with_http_info: #{e}"
end
```
...
> <ListApplicationCartItemFilters200Response> list_application_cart_item_filters(application_id, opts)
...
begin
  ...
  puts "Error when calling ManagementApi->list_application_cart_item_filters: #{e}"
end
```

#### Using the list_application_cart_item_filters_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<ListApplicationCartItemFilters200Response>, Integer, Hash)> list_application_cart_item_filters_with_http_info(application_id, opts)

```ruby
begin
  # List Application cart item filters
  data, status_code, headers = api_instance.list_application_cart_item_filters_with_http_info(application_id, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <ListApplicationCartItemFilters200Response>
rescue TalonOne::ApiError => e
  puts "Error when calling ManagementApi->list_application_cart_item_filters_with_http_info: #{e}"
end
```
...
> <ListExperiments200Response> list_experiments(application_id, opts)
...
begin
  ...
  puts "Error when calling ManagementApi->list_experiments: #{e}"
end
```

#### Using the list_experiments_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<ListExperiments200Response>, Integer, Hash)> list_experiments_with_http_info(application_id, opts)

```ruby
begin
  # List experiments
  data, status_code, headers = api_instance.list_experiments_with_http_info(application_id, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <ListExperiments200Response>
rescue TalonOne::ApiError => e
  puts "Error when calling ManagementApi->list_experiments_with_http_info: #{e}"
end
```
...
begin
  # Get summary of price history
  result = api_instance.price_history(application_id, price_history_request)
  p result
rescue TalonOne::ApiError => e
  puts "Error when calling ManagementApi->price_history: #{e}"
end
```
...
> <Array(<PriceHistoryResponse>, Integer, Hash)> price_history_with_http_info(application_id, price_history_request)

```ruby
begin
  # Get summary of price history
  data, status_code, headers = api_instance.price_history_with_http_info(application_id, price_history_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <PriceHistoryResponse>
rescue TalonOne::ApiError => e
  puts "Error when calling ManagementApi->price_history_with_http_info: #{e}"
end
```
