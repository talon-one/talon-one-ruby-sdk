...
TalonOne::EffectAllOfProps.openapi_one_of
# =>
# [
...
TalonOne::EffectAllOfProps.build(data)
# => #<AcceptCouponEffectProps:0x00007fdd4aab02a0>

TalonOne::EffectAllOfProps.build(data_that_doesnt_match)
# => nil
```
