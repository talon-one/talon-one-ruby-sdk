...
catalog_sync_request = TalonOne::CatalogSyncRequest.new({actions: [TalonOne::CatalogActionOneOf.new({type: 3.56, payload: TalonOne::AddItemCatalogAction.new({sku: 'SKU1241028'})})]}) # CatalogSyncRequest | body
