...
| **loyalty_programs** | **Hash&lt;String, String&gt;** | A map of the link between the loyalty program-related permission set and the loyalty program ID the permissions apply to. | [optional] |
| **campaign_access_groups** | **Hash&lt;String, String&gt;** | A map of the link between the campaign access group-related permission set and the campaign access group ID the permissions apply to. | [optional] |
