...
| **reserved_at** | **Time** | Timestamp when the coupon reservation was created. | [optional] |
...
instance = TalonOne::CustomerReservation.new(
  id: 6,
  ...
  sandbox: false,
  reserved_at: 2026-08-10T10:00:00Z
)
```
