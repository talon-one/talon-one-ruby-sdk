...
| **created** | **Time** | The exact moment this entity was created. |  |
...
| **last_activity** | **Time** | Timestamp of the most recent event received by this campaign. | [optional] |
| **updated** | **Time** | Timestamp of the most recent update to the campaign&#39;s property. Updates to external entities used in this campaign are **not** registered by this property, such as collection or coupon updates.  | [optional] |
